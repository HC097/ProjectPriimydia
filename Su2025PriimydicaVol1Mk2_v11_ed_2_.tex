...
\begin{center}
\textbf{\large A Note on the Making of This Book}
\end{center}

\vspace{1.5em}

\noindent
\textit{Priimydica} is my story, my world, and my creative project. In developing this book, I used generative artificial intelligence to help translate my outlines, scenes, characters, histories, ideas, and direction into prose. I extensively directed, revised, corrected, and edited that prose, and I take responsibility for the finished work.

\vspace{1em}

\noindent
Artificial intelligence was a tool in the making of this book. It contributed to the language through which the story was expressed, but the world, its history, its characters, its meaning, and the choices that shaped the work are mine.

\vspace{1em}

\noindent
In that sense, AI served as a translator for a story I wanted to tell.
